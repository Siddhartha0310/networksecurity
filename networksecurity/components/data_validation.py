...
class DataValidation:
    ...
    def validate_numerical_colums(self,dataframe:pd.DataFrame)->bool:
         try:
    ...
    def initiate_data_validation(self)->DataValidationArtifacts:
        try:
            ...
            status= self.validate_numerical_colums(dataframe=train_dataframe)
            if not status:
                error_message=f" train dataframe does not contain numerical datatype"

            status= self.validate_numerical_colums(dataframe=test_dataframe)
            if not status:
                error_message=f"test dataframe does not contain numerical datatype"
