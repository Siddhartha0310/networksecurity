...
class TrainingPipelineConfig:
    def __init__(self,timestamp=datetime.now()):
        ...
        self.artifiact_dir= os.path.join(self.artifact_name,timestamp)
        self.timestamp=timestamp

class DataIngestionConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
       self.data_ingestion_dir:str=os.path.join(
           training_pipeline_config.artifiact_dir,
...
class DataValidationConfig:
    def __init__(self,training_pipeline_cofig:TrainingPipelineConfig):
        self.data_validation_dir:str=os.path.join(training_pipeline_cofig.artifiact_dir,training_pipeline.DATA_VALIDATION_DIR_NAME)
...
class DataTransformationConfig:
     def __init__(self,training_pipeline_config:TrainingPipelineConfig):
                 self.data_transformation_dir:str=os.path.join(training_pipeline_config.artifiact_dir,training_pipeline.DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR)
...
class ModelTrainerConfig:
     def __init__(self,training_pipeline_config:TrainingPipelineConfig):
          self.model_trainer_dir:str=os.path.join(
               training_pipeline_config.artifiact_dir,training_pipeline.MODEL_TRAINER_DIR_NAME
               )
          ...
          self.expected_aacuracy:float=training_pipeline.MODEL_TRAINER_EXPECTED_SCORE
